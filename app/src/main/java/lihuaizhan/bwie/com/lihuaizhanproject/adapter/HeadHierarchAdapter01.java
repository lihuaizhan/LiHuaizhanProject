...
public class HeadHierarchAdapter01 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private Context context;
    private List<ClassifyBean.DataBean> list;
    private LayoutInflater inflater;

    public HeadHierarchAdapter01(Context context, List<ClassifyBean.DataBean> list) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ClassifyBean.DataBean dataBean = list.get((position+10));
